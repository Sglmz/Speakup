...
export default function LettersGameIntro({ navigation, route }) {
    ...
    <View style={styles.container} key={route?.key}>
      ...
      <View style={styles.content}>
        <Animatable.View animation="fadeInDown" delay={100}>
          <Icon name="alphabetical" size={80} color="#81C784" style={{ marginBottom: 30 }} />
        </Animatable.View>
        ...
        <Animatable.Text animation="fadeInUp" delay={500} style={styles.subtitle}>
          ¿Listo para aprender las letras del abecedario en inglés?
        </Animatable.Text>
        ...
        <Animatable.View animation="fadeInUp" delay={1100}>
          <TouchableOpacity
            style={styles.button}
            onPress={() => navigation.replace('AllLettersScreen', { categoria: 'letras' })}
            activeOpacity={0.85}
          >
